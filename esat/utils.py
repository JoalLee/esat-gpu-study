...
def memory_estimate(n_features, n_samples, factors, cores: int = None):
    ...
    max_bytes = np.round(32 * ((n_features * n_samples)*3 + (n_features * factors) + (n_samples * factors)),4) + 150*(1024**2)
